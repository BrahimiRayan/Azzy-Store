<template>
        <div class="h-full ">
             ...
             v-model="open"
              ...
              :ui="{
                ...
                <template #body>
                    ...
                    <UButton label="Submit" type="submit" class="mr-6 text-[var(--deep-dark-blue)] borde border-white"/>
            ...
            <!-- notifcation card -->
            <div v-for="_ in 10" class="border-2 p-4 border-[var(--green-grace)] rounded-2xl mb-6 bg-amber-50/5">
