...
<div class="flex items-center justify-between w-full mb-3 ">
    ...
    <ul class="flex gap-3 items-center">
            ...
            <div class="w-max p-1 rounded font-[--font-style] flex items-center gap-2 bg-white/40 ">
            ...
            <div class="self-start border-t-2 w-full pt-3 ">
                <p class="font-extrabold flex items-center gap-2 text-sm"><span class="flex items-center gap-1"><UIcon name="i-carbon-delivery"/> Livraison :</span>
