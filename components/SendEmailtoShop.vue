<template>
  ...
  <div class="relative group">
    ...
    <button 
      v-else
      @click="ToggleFormVisible"
      class="bg-white/50 py-1 px-2 rounded font-extrabold shadow shadow-black/70 hover:translate-y-1 transition-all duration-300 ease-in-out Contactbutton"
      title="Envoyer un message"
      aria-label="Ouvrir le formulaire de contact"
    >
        <UIcon name="i-lucide-send" class="text-center" />
    </button>
