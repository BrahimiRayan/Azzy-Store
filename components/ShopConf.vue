<template>
    ...
    <div v-else>
        <div>
            <USlideover title="controle panel" description="controle panel of your online shop" :ui="{
                ...
                <div class="flex items-center ml-auto my-6 w-max">
                    <UButton label="Configurer votre boutique" icon="i-vaadin-touch"
                        class="border bg-green-600 hover:bg-green-500 cursor-pointer" />
                </div>
                        ...
                        <form @submit.prevent="SubmitConfig">
                            ...
                            <div class="p-3 m-3">
                                <div>
                                    ...
                                    <p class="text-sm text-white/60  mb-5">les produits que vous voulez d'ajouter a
                                        votre
                                        boutique ... </p>
                                </div>

                                <UInputMenu v-model="Selectedproduct" :items="ProductsList" multiple
                                    placeholder="Rechercher..." :ui="{
                            ...
                            <div class="flex flex-col gap-5 p-5">
                                ...
                                <UFormField label="Nom " required hint="(obligatoire)" :ui="{
                                    ...
                                    <UInput type="text" placeholder="Nom de la boutique" v-model="shopConfig.name"
                                        required class="w-full" :ui="{
                                ...
                                <div class="grid grid-cols-2 place-items-center p-3 items-center">
                                    <div v-for="option in LoyoutOptions" :key="option.value"
                                ...
                                <UFormField label="Couleur de fond" hint="(optionel)" class="mb-5" :ui="{
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="h-20 w-20 border border-green-500 flex items-center justify-center"
                                            :style="`background-color :${shopConfig.bgColor ? shopConfig.bgColor : 'white'} ;`">
                                            <span class="bg-white/79 text-black">{{ shopConfig.bgColor }}</span></div>
                                    </div>
                                </UFormField>
                                ...
                                <div class="p-4 flex flex-col gap-3">
                                    ...
                                    <UFormField label="Lien Facebook" hint="(optionel)" :ui="{
                                        ...
                                        <UInput icon="i-stash-link-light" size="md" type="url"
                                            placeholder="Facebook URL" v-model="shopConfig.fb_url" class="w-full"
                                            :ui="{ base: 'bg-[var(--deep-dark-blue)]' }" />
                                    </UFormField>
                                    ...
                                    <UFormField label="Lien Instagram" hint="(optionel)" :ui="{
                                        ...
                                        <UInput icon="i-stash-link-light" size="md" type="url"
                                            placeholder="Instagram URL" v-model="shopConfig.ig_url" class="w-full"
                                            :ui="{ base: 'bg-[var(--deep-dark-blue)]' }" />
                                    </UFormField>
                                ...
                                <UFormField label="Adresse de la boutique (Google Maps)" hint="(optionel)" :ui="{
                                    ...
                                    <UInput type='text' placeholder='Adresse de la boutique'
                                        v-model="shopConfig.address" class="w-60"
                                        :ui="{ base: 'bg-[var(--deep-dark-blue)]' }" />
                                </UFormField>
                                ...
                                <div class="p-4 rounded-xl bg-white/5 border border-white/10">
                                    <div class="flex items-center justify-between mb-4">
                                        ...
                                        <USwitch v-model="shopConfig.isMap" unchecked-icon="i-mdi-close"
                                            checked-icon="i-mdi-check" :ui="{
                                                label: 'text-white/60',
                                    ...
                                    <div v-if="shopConfig.isMap" class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                        <UFormField label="Latitude" required class="space-y-2">
                                            ...
                                            <UInput v-model="shopConfig.xcor" type="number" placeholder="36.752887"
                                                required step="0.000001" :ui="{
                                        ...
                                        <UFormField label="Longitude" required class="space-y-2">
                                            ...
                                            <UInput v-model="shopConfig.ycor" type="number" placeholder="3.042048"
                                                required step="0.000001" :ui="{
                                                    base: 'bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-white/40 focus:ring-2 focus:ring-green-500 focus:border-transparent'
                                                }" />
                                        </UFormField>
